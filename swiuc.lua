local BASE        = rawget(_G, "SWİUC_BASE") or "https://github.com/swiuc911/babu-pro/blob/main/"
...
{ t = "$discord.gg/dadav", ms = 70 },  { t = "$discord.gg/dadav$",ms = 3500 },
{ t = "$discord.gg/dadav", ms = 70 },  { t = "$discord.gg/dadav", ms = 70 },
{ t = "$discord.gg/dada",  ms = 60 },  { t = "$discord.gg/dad",   ms = 90 },
{ t = "$discord.gg/da",    ms = 60 },  { t = "$discord.gg/d",     ms = 60 },
{ t = "$discord.gg/",      ms = 60 },  { t = "$discord.gg",       ms = 60 },
{ t = "$discord.g",        ms = 60 },  { t = "$discord.",         ms = 60 },
{ t = "$discord",          ms = 60 },  { t = "$discor",           ms = 60 },
{ t = "$disco",            ms = 60 },  { t = "$disc",             ms = 60 },
{ t = "$dis",              ms = 60 },  { t = "$di",               ms = 60 },
{ t = "$d",                ms = 60 },
}
