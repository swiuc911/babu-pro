...
local T = {
    ...
    bg      = { 16, 18, 24, 255 },     -- ana arkaplan, koyu grafit
    bg2     = { 22, 25, 32, 255 },     -- ikincil arkaplan, biraz daha açık
    section = { 20, 22, 29, 255 },     -- bölüm arkaplanı
    accent    = { 130, 90, 255, 255 }, -- mor accent (slider dolu kısmı)
    accent_bg = { 38, 34, 58, 255 },   -- koyu mor (slider boş/track kısmı)
    border    = { 44, 47, 58, 255 },   -- ince koyu border
    divider   = { 30, 32, 40, 255 },
    text      = { 230, 230, 240, 255 }, -- kırık beyaz yazı (label'lar)
    textdim   = { 130, 133, 148, 255 }, -- soluk yazı
    texthi    = { 80, 220, 255, 255 },  -- slider içindeki cyan değer yazısı
    widget    = { 28, 30, 38, 255 },    -- widget gövdesi (checkbox/slider)
    widgethi  = { 130, 90, 255, 255 },  -- mor hover/highlight
    title     = "discord.gg",
    title_tld = "/dadav",
    titlebar  = 44,
    pad       = 14,
