...
local AGENTS = {
    { id=4613, team="T", name="customplayer_tm_professional_varf5", path="agents/models/tm_professional/tm_professional_varf5.vmdl", label="Sir Bloody Miami Darryl | The Professionals" },
    { id=4718, team="T", name="customplayer_tm_balkan_variantk", path="agents/models/tm_balkan/tm_balkan_variantk.vmdl", label="Rezan the Redshirt | Sabre" },
    { id=4726, team="T", name="customplayer_tm_professional_varf", path="agents/models/tm_professional/tm_professional_varf.vmdl", label="Sir Bloody Miami Darryl | The Professionals" },
    { id=4727, team="T", name="customplayer_tm_professional_varg", path="agents/models/tm_professional/tm_professional_varg.vmdl", label="Safecracker Voltzmann | The Professionals" },
    { id=4728, team="T", name="customplayer_tm_professional_varh", path="agents/models/tm_professional/tm_professional_varh.vmdl", label="Little Kev | The Professionals" },
    { id=4730, team="T", name="customplayer_tm_professional_varj", path="agents/models/tm_professional/tm_professional_varj.vmdl", label="Getaway Sally | The Professionals" },
    { id=4732, team="T", name="customplayer_tm_professional_vari", path="agents/models/tm_professional/tm_professional_vari.vmdl", label="Number K | The Professionals" },
    { id=4733, team="T", name="customplayer_tm_professional_varf1", path="agents/models/tm_professional/tm_professional_varf1.vmdl", label="Sir Bloody Silent Darryl | The Professionals" },
    { id=4734, team="T", name="customplayer_tm_professional_varf2", path="agents/models/tm_professional/tm_professional_varf2.vmdl", label="Sir Bloody Skullhead Darryl | The Professionals" },
    { id=4735, team="T", name="customplayer_tm_professional_varf3", path="agents/models/tm_professional/tm_professional_varf3.vmdl", label="Sir Bloody Darryl Royale | The Professionals" },
    { id=4736, team="T", name="customplayer_tm_professional_varf4", path="agents/models/tm_professional/tm_professional_varf4.vmdl", label="Sir Bloody Loudmouth Darryl | The Professionals" },
    { id=4773, team="T", name="customplayer_tm_jungle_raider_varianta", path="agents/models/tm_jungle_raider/tm_jungle_raider_varianta.vmdl", label="Elite Trapper Solman | Guerrilla Warfare" },
    { id=4774, team="T", name="customplayer_tm_jungle_raider_variantb", path="agents/models/tm_jungle_raider/tm_jungle_raider_variantb.vmdl", label="Crasswater The Forgotten | Guerrilla Warfare" },
    { id=4775, team="T", name="customplayer_tm_jungle_raider_variantc", path="agents/models/tm_jungle_raider/tm_jungle_raider_variantc.vmdl", label="Arno The Overgrown | Guerrilla Warfare" },
    { id=4776, team="T", name="customplayer_tm_jungle_raider_variantd", path="agents/models/tm_jungle_raider/tm_jungle_raider_variantd.vmdl", label="Col. Mangos Dabisi | Guerrilla Warfare" },
    { id=4777, team="T", name="customplayer_tm_jungle_raider_variante", path="agents/models/tm_jungle_raider/tm_jungle_raider_variante.vmdl", label="Vypa Sista of the Revolution | Guerrilla Warfare" },
    { id=4778, team="T", name="customplayer_tm_jungle_raider_variantf", path="agents/models/tm_jungle_raider/tm_jungle_raider_variantf.vmdl", label="Trapper | Guerrilla Warfare" },
    { id=4780, team="T", name="customplayer_tm_jungle_raider_variantb2", path="agents/models/tm_jungle_raider/tm_jungle_raider_variantb2.vmdl", label="'Medium Rare' Crasswater | Guerrilla Warfare" },
    { id=4781, team="T", name="customplayer_tm_jungle_raider_variantf2", path="agents/models/tm_jungle_raider/tm_jungle_raider_variantf2.vmdl", label="Trapper Aggressor | Guerrilla Warfare" },
    { id=5038, team="T", name="customplayer_tm_anarchist", path="agents/models/tm_anarchist/tm_anarchist.vmdl", label="[T] Anarchist | Default" },
    { id=5039, team="T", name="customplayer_tm_anarchist_varianta", path="agents/models/tm_anarchist/tm_anarchist_varianta.vmdl", label="[T] Anarchist (varianta) | Default" },
    { id=5040, team="T", name="customplayer_tm_anarchist_variantb", path="agents/models/tm_anarchist/tm_anarchist_variantb.vmdl", label="[T] Anarchist (variantb) | Default" },
    { id=5041, team="T", name="customplayer_tm_anarchist_variantc", path="agents/models/tm_anarchist/tm_anarchist_variantc.vmdl", label="[T] Anarchist (variantc) | Default" },
    { id=5042, team="T", name="customplayer_tm_anarchist_variantd", path="agents/models/tm_anarchist/tm_anarchist_variantd.vmdl", label="[T] Anarchist (variantd) | Default" },
    { id=5043, team="T", name="customplayer_tm_pirate", path="agents/models/tm_pirate/tm_pirate.vmdl", label="[T] Pirate | Default" },
    { id=5044, team="T", name="customplayer_tm_pirate_varianta", path="agents/models/tm_pirate/tm_pirate_varianta.vmdl", label="[T] Pirate (varianta) | Default" },
    { id=5045, team="T", name="customplayer_tm_pirate_variantb", path="agents/models/tm_pirate/tm_pirate_variantb.vmdl", label="[T] Pirate (variantb) | Default" },
    { id=5046, team="T", name="customplayer_tm_pirate_variantc", path="agents/models/tm_pirate/tm_pirate_variantc.vmdl", label="[T] Pirate (variantc) | Default" },
    { id=5047, team="T", name="customplayer_tm_pirate_variantd", path="agents/models/tm_pirate/tm_pirate_variantd.vmdl", label="[T] Pirate (variantd) | Default" },
    { id=5048, team="T", name="customplayer_tm_professional", path="agents/models/tm_professional/tm_professional.vmdl", label="[T] Professional | Default" },
    { id=5049, team="T", name="customplayer_tm_professional_var1", path="agents/models/tm_professional/tm_professional_var1.vmdl", label="[T] Professional (var1) | Default" },
    { id=5050, team="T", name="customplayer_tm_professional_var2", path="agents/models/tm_professional/tm_professional_var2.vmdl", label="[T] Professional (var2) | Default" },
    { id=5051, team="T", name="customplayer_tm_professional_var3", path="agents/models/tm_professional/tm_professional_var3.vmdl", label="[T] Professional (var3) | Default" },
    { id=5052, team="T", name="customplayer_tm_professional_var4", path="agents/models/tm_professional/tm_professional_var4.vmdl", label="[T] Professional (var4) | Default" },
    { id=5053, team="T", name="customplayer_tm_separatist", path="agents/models/tm_separatist/tm_separatist.vmdl", label="[T] Separatist | Default" },
    { id=5054, team="T", name="customplayer_tm_separatist_varianta", path="agents/models/tm_separatist/tm_separatist_varianta.vmdl", label="[T] Separatist (varianta) | Default" },
    { id=5055, team="T", name="customplayer_tm_separatist_variantb", path="agents/models/tm_separatist/tm_separatist_variantb.vmdl", label="[T] Separatist (variantb) | Default" },
    { id=5056, team="T", name="customplayer_tm_separatist_variantc", path="agents/models/tm_separatist/tm_separatist_variantc.vmdl", label="[T] Separatist (variantc) | Default" },
    { id=5057, team="T", name="customplayer_tm_separatist_variantd", path="agents/models/tm_separatist/tm_separatist_variantd.vmdl", label="[T] Separatist (variantd) | Default" },
    { id=5088, team="T", name="customplayer_tm_balkan_variante", path="agents/models/tm_balkan/tm_balkan_variante.vmdl", label="[T] Balkan (variante) | Default" },
    { id=5089, team="T", name="customplayer_tm_balkan_varianta", path="agents/models/tm_balkan/tm_balkan_varianta.vmdl", label="[T] Balkan (varianta) | Default" },
    { id=5090, team="T", name="customplayer_tm_balkan_variantb", path="agents/models/tm_balkan/tm_balkan_variantb.vmdl", label="[T] Balkan (variantb) | Default" },
    { id=5091, team="T", name="customplayer_tm_balkan_variantc", path="agents/models/tm_balkan/tm_balkan_variantc.vmdl", label="[T] Balkan (variantc) | Default" },
    { id=5092, team="T", name="customplayer_tm_balkan_variantd", path="agents/models/tm_balkan/tm_balkan_variantd.vmdl", label="[T] Balkan (variantd) | Default" },
    { id=5093, team="T", name="customplayer_tm_jumpsuit_varianta", path="agents/models/tm_jumpsuit/tm_jumpsuit_varianta.vmdl", label="[T] Jumpsuit (varianta) | Default" },
    { id=5094, team="T", name="customplayer_tm_jumpsuit_variantb", path="agents/models/tm_jumpsuit/tm_jumpsuit_variantb.vmdl", label="[T] Jumpsuit (variantb) | Default" },
    { id=5095, team="T", name="customplayer_tm_jumpsuit_variantc", path="agents/models/tm_jumpsuit/tm_jumpsuit_variantc.vmdl", label="[T] Jumpsuit (variantc) | Default" },
    { id=5096, team="T", name="customplayer_tm_phoenix_heavy", path="agents/models/tm_phoenix_heavy/tm_phoenix_heavy.vmdl", label="[T] Phoenix Heavy | Default" },
    { id=5100, team="T", name="customplayer_tm_leet_varianta", path="agents/models/tm_leet/tm_leet_varianta.vmdl", label="[T] Elite (varianta) | Default" },
    { id=5101, team="T", name="customplayer_tm_leet_variantb", path="agents/models/tm_leet/tm_leet_variantb.vmdl", label="[T] Elite (variantb) | Default" },
    { id=5102, team="T", name="customplayer_tm_leet_variantc", path="agents/models/tm_leet/tm_leet_variantc.vmdl", label="[T] Elite (variantc) | Default" },
    { id=5103, team="T", name="customplayer_tm_leet_variantd", path="agents/models/tm_leet/tm_leet_variantd.vmdl", label="[T] Elite (variantd) | Default" },
    { id=5104, team="T", name="customplayer_tm_leet_variante", path="agents/models/tm_leet/tm_leet_variante.vmdl", label="[T] Elite (variante) | Default" },
    { id=5105, team="T", name="customplayer_tm_leet_variantg", path="agents/models/tm_leet/tm_leet_variantg.vmdl", label="Ground Rebel | Elite Crew" },
    { id=5106, team="T", name="customplayer_tm_leet_varianth", path="agents/models/tm_leet/tm_leet_varianth.vmdl", label="Osiris | Elite Crew" },
    { id=5107, team="T", name="customplayer_tm_leet_varianti", path="agents/models/tm_leet/tm_leet_varianti.vmdl", label="Prof. Shahmat | Elite Crew" },
    { id=5108, team="T", name="customplayer_tm_leet_variantf", path="agents/models/tm_leet/tm_leet_variantf.vmdl", label="The Elite Mr. Muhlik | Elite Crew" },
    { id=5109, team="T", name="customplayer_tm_leet_variantj", path="agents/models/tm_leet/tm_leet_variantj.vmdl", label="Jungle Rebel | Elite Crew" },
    { id=5200, team="T", name="customplayer_tm_phoenix", path="agents/models/tm_phoenix/tm_phoenix.vmdl", label="[T] Phoenix | Default" },
    { id=5201, team="T", name="customplayer_tm_phoenix_varianta", path="agents/models/tm_phoenix/tm_phoenix_varianta.vmdl", label="[T] Phoenix (varianta) | Default" },
    { id=5202, team="T", name="customplayer_tm_phoenix_variantb", path="agents/models/tm_phoenix/tm_phoenix_variantb.vmdl", label="[T] Phoenix (variantb) | Default" },
    { id=5203, team="T", name="customplayer_tm_phoenix_variantc", path="agents/models/tm_phoenix/tm_phoenix_variantc.vmdl", label="[T] Phoenix (variantc) | Default" },
    { id=5204, team="T", name="customplayer_tm_phoenix_variantd", path="agents/models/tm_phoenix/tm_phoenix_variantd.vmdl", label="[T] Phoenix (variantd) | Default" },
    { id=5205, team="T", name="customplayer_tm_phoenix_varianth", path="agents/models/tm_phoenix/tm_phoenix_varianth.vmdl", label="Slingshot | Phoenix" },
    { id=5206, team="T", name="customplayer_tm_phoenix_variantf", path="agents/models/tm_phoenix/tm_phoenix_variantf.vmdl", label="Enforcer | Phoenix" },
    { id=5207, team="T", name="customplayer_tm_phoenix_variantg", path="agents/models/tm_phoenix/tm_phoenix_variantg.vmdl", label="Slingshot | Phoenix" },
    { id=5208, team="T", name="customplayer_tm_phoenix_varianti", path="agents/models/tm_phoenix/tm_phoenix_varianti.vmdl", label="Street Soldier | Phoenix" },
    { id=5500, team="T", name="customplayer_tm_balkan_variantf", path="agents/models/tm_balkan/tm_balkan_variantf.vmdl", label="Dragomir | Sabre" },
    { id=5501, team="T", name="customplayer_tm_balkan_varianti", path="agents/models/tm_balkan/tm_balkan_varianti.vmdl", label="Maximus | Sabre" },
    { id=5502, team="T", name="customplayer_tm_balkan_variantg", path="agents/models/tm_balkan/tm_balkan_variantg.vmdl", label="Rezan The Ready | Sabre" },
    { id=5503, team="T", name="customplayer_tm_balkan_variantj", path="agents/models/tm_balkan/tm_balkan_variantj.vmdl", label="Blackwolf | Sabre" },
    { id=5504, team="T", name="customplayer_tm_balkan_varianth", path="agents/models/tm_balkan/tm_balkan_varianth.vmdl", label="'The Doctor' Romanov | Sabre" },
    { id=5505, team="T", name="customplayer_tm_balkan_variantl", path="agents/models/tm_balkan/tm_balkan_variantl.vmdl", label="Dragomir | Sabre" },
    { id=4619, team="CT", name="customplayer_ctm_st6_variantj", path="agents/models/ctm_st6/ctm_st6_variantj.vmdl", label="'Blueberries' Buckshot | NSWC SEAL" },
    { id=4680, team="CT", name="customplayer_ctm_st6_variantl", path="agents/models/ctm_st6/ctm_st6_variantl.vmdl", label="'Two Times' McCoy | TACP Cavalry" },
    { id=4711, team="CT", name="customplayer_ctm_swat_variante", path="agents/models/ctm_swat/ctm_swat_variante.vmdl", label="Cmdr. Mae 'Dead Cold' Jamison | SWAT" },
    { id=4712, team="CT", name="customplayer_ctm_swat_variantf", path="agents/models/ctm_swat/ctm_swat_variantf.vmdl", label="1st Lieutenant Farlow | SWAT" },
    { id=4713, team="CT", name="customplayer_ctm_swat_variantg", path="agents/models/ctm_swat/ctm_swat_variantg.vmdl", label="John 'Van Healen' Kask | SWAT" },
    { id=4714, team="CT", name="customplayer_ctm_swat_varianth", path="agents/models/ctm_swat/ctm_swat_varianth.vmdl", label="Bio-Haz Specialist | SWAT" },
    { id=4715, team="CT", name="customplayer_ctm_swat_varianti", path="agents/models/ctm_swat/ctm_swat_varianti.vmdl", label="Sergeant Bombson | SWAT" },
    { id=4716, team="CT", name="customplayer_ctm_swat_variantj", path="agents/models/ctm_swat/ctm_swat_variantj.vmdl", label="Chem-Haz Specialist | SWAT" },
    { id=4749, team="CT", name="customplayer_ctm_gendarmerie_varianta", path="agents/models/ctm_gendarmerie/ctm_gendarmerie_varianta.vmdl", label="Sous-Lieutenant Medic | Gendarmerie" },
    { id=4750, team="CT", name="customplayer_ctm_gendarmerie_variantb", path="agents/models/ctm_gendarmerie/ctm_gendarmerie_variantb.vmdl", label="Chem-Haz Capitaine | Gendarmerie" },
    { id=4751, team="CT", name="customplayer_ctm_gendarmerie_variantc", path="agents/models/ctm_gendarmerie/ctm_gendarmerie_variantc.vmdl", label="Chef d'Escadron Rouchard | Gendarmerie" },
    { id=4752, team="CT", name="customplayer_ctm_gendarmerie_variantd", path="agents/models/ctm_gendarmerie/ctm_gendarmerie_variantd.vmdl", label="Aspirant | Gendarmerie" },
    { id=4753, team="CT", name="customplayer_ctm_gendarmerie_variante", path="agents/models/ctm_gendarmerie/ctm_gendarmerie_variante.vmdl", label="Officer Jacques Beltram | Gendarmerie" },
    { id=4756, team="CT", name="customplayer_ctm_swat_variantk", path="agents/models/ctm_swat/ctm_swat_variantk.vmdl", label="Lieutenant 'Tree Hugger' Farlow | SWAT" },
    { id=4757, team="CT", name="customplayer_ctm_diver_varianta", path="agents/models/ctm_diver/ctm_diver_varianta.vmdl", label="Cmdr. Davida 'Goggles' Fernandez | SEAL Frogman" },
    { id=4771, team="CT", name="customplayer_ctm_diver_variantb", path="agents/models/ctm_diver/ctm_diver_variantb.vmdl", label="Cmdr. Frank 'Wet Sox' Baroud | SEAL Frogman" },
    { id=4772, team="CT", name="customplayer_ctm_diver_variantc", path="agents/models/ctm_diver/ctm_diver_variantc.vmdl", label="Lieutenant Rex Krikey | SEAL Frogman" },
    { id=5058, team="CT", name="customplayer_ctm_gign", path="agents/models/ctm_gign/ctm_gign.vmdl", label="[CT] GIGN | Default" },
    { id=5059, team="CT", name="customplayer_ctm_gign_varianta", path="agents/models/ctm_gign/ctm_gign_varianta.vmdl", label="[CT] GIGN (varianta) | Default" },
    { id=5060, team="CT", name="customplayer_ctm_gign_variantb", path="agents/models/ctm_gign/ctm_gign_variantb.vmdl", label="[CT] GIGN (variantb) | Default" },
    { id=5061, team="CT", name="customplayer_ctm_gign_variantc", path="agents/models/ctm_gign/ctm_gign_variantc.vmdl", label="[CT] GIGN (variantc) | Default" },
    { id=5062, team="CT", name="customplayer_ctm_gign_variantd", path="agents/models/ctm_gign/ctm_gign_variantd.vmdl", label="[CT] GIGN (variantd) | Default" },
    { id=5063, team="CT", name="customplayer_ctm_gsg9", path="agents/models/ctm_gsg9/ctm_gsg9.vmdl", label="[CT] GSG9 | Default" },
    { id=5064, team="CT", name="customplayer_ctm_gsg9_varianta", path="agents/models/ctm_gsg9/ctm_gsg9_varianta.vmdl", label="[CT] GSG9 (varianta) | Default" },
    { id=5065, team="CT", name="customplayer_ctm_gsg9_variantb", path="agents/models/ctm_gsg9/ctm_gsg9_variantb.vmdl", label="[CT] GSG9 (variantb) | Default" },
    { id=5066, team="CT", name="customplayer_ctm_gsg9_variantc", path="agents/models/ctm_gsg9/ctm_gsg9_variantc.vmdl", label="[CT] GSG9 (variantc) | Default" },
    { id=5067, team="CT", name="customplayer_ctm_gsg9_variantd", path="agents/models/ctm_gsg9/ctm_gsg9_variantd.vmdl", label="[CT] GSG9 (variantd) | Default" },
    { id=5068, team="CT", name="customplayer_ctm_idf", path="agents/models/ctm_idf/ctm_idf.vmdl", label="[CT] IDF | Default" },
    { id=5069, team="CT", name="customplayer_ctm_idf_variantb", path="agents/models/ctm_idf/ctm_idf_variantb.vmdl", label="[CT] IDF (variantb) | Default" },
    { id=5070, team="CT", name="customplayer_ctm_idf_variantc", path="agents/models/ctm_idf/ctm_idf_variantc.vmdl", label="[CT] IDF (variantc) | Default" },
    { id=5071, team="CT", name="customplayer_ctm_idf_variantd", path="agents/models/ctm_idf/ctm_idf_variantd.vmdl", label="[CT] IDF (variantd) | Default" },
    { id=5072, team="CT", name="customplayer_ctm_idf_variante", path="agents/models/ctm_idf/ctm_idf_variante.vmdl", label="[CT] IDF (variante) | Default" },
    { id=5073, team="CT", name="customplayer_ctm_idf_variantf", path="agents/models/ctm_idf/ctm_idf_variantf.vmdl", label="[CT] IDF (variantf) | Default" },
    { id=5074, team="CT", name="customplayer_ctm_swat", path="agents/models/ctm_swat/ctm_swat.vmdl", label="[CT] SWAT | Default" },
    { id=5075, team="CT", name="customplayer_ctm_swat_varianta", path="agents/models/ctm_swat/ctm_swat_varianta.vmdl", label="[CT] SWAT (varianta) | Default" },
    { id=5076, team="CT", name="customplayer_ctm_swat_variantb", path="agents/models/ctm_swat/ctm_swat_variantb.vmdl", label="[CT] SWAT (variantb) | Default" },
    { id=5077, team="CT", name="customplayer_ctm_swat_variantc", path="agents/models/ctm_swat/ctm_swat_variantc.vmdl", label="[CT] SWAT (variantc) | Default" },
    { id=5078, team="CT", name="customplayer_ctm_swat_variantd", path="agents/models/ctm_swat/ctm_swat_variantd.vmdl", label="[CT] SWAT (variantd) | Default" },
    { id=5079, team="CT", name="customplayer_ctm_sas_varianta", path="agents/models/ctm_sas/ctm_sas_varianta.vmdl", label="[CT] SAS (varianta) | Default" },
    { id=5080, team="CT", name="customplayer_ctm_sas_variantb", path="agents/models/ctm_sas/ctm_sas_variantb.vmdl", label="[CT] SAS (variantb) | Default" },
    { id=5081, team="CT", name="customplayer_ctm_sas_variantc", path="agents/models/ctm_sas/ctm_sas_variantc.vmdl", label="[CT] SAS (variantc) | Default" },
    { id=5082, team="CT", name="customplayer_ctm_sas_variantd", path="agents/models/ctm_sas/ctm_sas_variantd.vmdl", label="[CT] SAS (variantd) | Default" },
    { id=5083, team="CT", name="customplayer_ctm_st6", path="agents/models/ctm_st6/ctm_st6.vmdl", label="[CT] ST6 | Default" },
    { id=5084, team="CT", name="customplayer_ctm_st6_varianta", path="agents/models/ctm_st6/ctm_st6_varianta.vmdl", label="[CT] ST6 (varianta) | Default" },
    { id=5085, team="CT", name="customplayer_ctm_st6_variantb", path="agents/models/ctm_st6/ctm_st6_variantb.vmdl", label="[CT] ST6 (variantb) | Default" },
    { id=5086, team="CT", name="customplayer_ctm_st6_variantc", path="agents/models/ctm_st6/ctm_st6_variantc.vmdl", label="[CT] ST6 (variantc) | Default" },
    { id=5087, team="CT", name="customplayer_ctm_st6_variantd", path="agents/models/ctm_st6/ctm_st6_variantd.vmdl", label="[CT] ST6 (variantd) | Default" },
    { id=5097, team="CT", name="customplayer_ctm_heavy", path="agents/models/ctm_heavy/ctm_heavy.vmdl", label="[CT] Heavy | Default" },
    { id=5300, team="CT", name="customplayer_ctm_fbi", path="agents/models/ctm_fbi/ctm_fbi.vmdl", label="[CT] FBI | Default" },
    { id=5301, team="CT", name="customplayer_ctm_fbi_varianta", path="agents/models/ctm_fbi/ctm_fbi_varianta.vmdl", label="[CT] FBI (varianta) | Default" },
    { id=5302, team="CT", name="customplayer_ctm_fbi_variantc", path="agents/models/ctm_fbi/ctm_fbi_variantc.vmdl", label="[CT] FBI (variantc) | Default" },
    { id=5303, team="CT", name="customplayer_ctm_fbi_variantd", path="agents/models/ctm_fbi/ctm_fbi_variantd.vmdl", label="[CT] FBI (variantd) | Default" },
    { id=5304, team="CT", name="customplayer_ctm_fbi_variante", path="agents/models/ctm_fbi/ctm_fbi_variante.vmdl", label="[CT] FBI (variante) | Default" },
    { id=5305, team="CT", name="customplayer_ctm_fbi_variantf", path="agents/models/ctm_fbi/ctm_fbi_variantf.vmdl", label="Special Agent | FBI SWAT" },
    { id=5306, team="CT", name="customplayer_ctm_fbi_variantg", path="agents/models/ctm_fbi/ctm_fbi_variantg.vmdl", label="Markus Delrow | FBI HRT" },
    { id=5307, team="CT", name="customplayer_ctm_fbi_varianth", path="agents/models/ctm_fbi/ctm_fbi_varianth.vmdl", label="Michael Syfers | FBI Sniper" },
    { id=5308, team="CT", name="customplayer_ctm_fbi_variantb", path="agents/models/ctm_fbi/ctm_fbi_variantb.vmdl", label="Special Agent Ava | FBI" },
    { id=5400, team="CT", name="customplayer_ctm_st6_variantk", path="agents/models/ctm_st6/ctm_st6_variantk.vmdl", label="3rd Commando Company | KSK" },
    { id=5401, team="CT", name="customplayer_ctm_st6_variante", path="agents/models/ctm_st6/ctm_st6_variante.vmdl", label="Seal Team 6 Soldier | NSWC SEAL" },
    { id=5402, team="CT", name="customplayer_ctm_st6_variantg", path="agents/models/ctm_st6/ctm_st6_variantg.vmdl", label="Buckshot | NSWC SEAL" },
    { id=5403, team="CT", name="customplayer_ctm_st6_variantm", path="agents/models/ctm_st6/ctm_st6_variantm.vmdl", label="'Two Times' McCoy | USAF TACP" },
    { id=5404, team="CT", name="customplayer_ctm_st6_varianti", path="agents/models/ctm_st6/ctm_st6_varianti.vmdl", label="Lt. Commander Ricksaw | NSWC SEAL" },
    { id=5405, team="CT", name="customplayer_ctm_st6_variantn", path="agents/models/ctm_st6/ctm_st6_variantn.vmdl", label="Primeiro Tenente | Brazilian 1st Battalion" },
    { id=5600, team="CT", name="customplayer_ctm_sas", path="agents/models/ctm_sas/ctm_sas.vmdl", label="[CT] SAS | Default" },
    { id=5601, team="CT", name="customplayer_ctm_sas_variantf", path="agents/models/ctm_sas/ctm_sas_variantf.vmdl", label="B Squadron Officer | SAS" },
    { id=5602, team="CT", name="customplayer_ctm_sas_variantg", path="agents/models/ctm_sas/ctm_sas_variantg.vmdl", label="D Squadron Officer | NZSAS" },
}
